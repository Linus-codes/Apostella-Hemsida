export const en = {
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: 'When you contact us', text: 'If you email us, call us or book a meeting through the booking link, you leave this site. The email and the booking system are run by Microsoft on our behalf, and the details you give us there are handled as part of the assignment you ask us to carry out. We keep them for as long as the assignment and the law require.' },
