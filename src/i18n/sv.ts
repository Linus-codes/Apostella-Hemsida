...
export const sv: Strings = {
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: 'När du kontaktar oss', text: 'Mejlar du, ringer du eller bokar ett möte via bokningslänken lämnar du den här sajten. Mejlen och bokningssystemet drivs av Microsoft för vår räkning, och uppgifterna du lämnar där hanteras som en del av det uppdrag du ber oss utföra. Vi sparar dem så länge uppdraget och lagen kräver.' },
